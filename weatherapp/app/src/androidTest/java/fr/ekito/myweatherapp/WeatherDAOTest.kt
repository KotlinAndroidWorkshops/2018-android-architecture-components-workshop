...
//import fr.ekito.myweatherapp.domain.getDailyForecasts
//import fr.ekito.myweatherapp.domain.getLocation
...
//    @Before()
//    fun before() {
//        loadKoinModules(*offlineWeatherApp.toTypedArray(), roomTestModule)
//    }
//
//    @After
//    fun after() {
